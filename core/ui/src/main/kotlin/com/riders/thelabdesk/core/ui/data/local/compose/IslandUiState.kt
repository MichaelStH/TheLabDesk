package com.riders.thelabdesk.core.ui.data.local.compose
...
sealed class IslandUiState(
    ...
    val leadingContentSize: Dp = Dp.Companion.Hairline,
    val hasLeadingContent: Boolean = false,

    val trailingContentSize: Dp = Dp.Companion.Hairline,
