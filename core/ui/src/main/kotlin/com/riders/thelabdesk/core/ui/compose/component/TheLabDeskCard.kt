...
import com.riders.thelabdesk.core.ui.compose.theme.*
...
fun TheLabDeskCard(
    ...
    LaunchedEffect(!isSystemInDarkTheme()) {
        animatedColor.animateTo(
            if (!SystemManager.isSystemInDarkTheme()) currentTheme.first.getColorScheme().primaryContainer else currentTheme.second.getColorScheme().background,
