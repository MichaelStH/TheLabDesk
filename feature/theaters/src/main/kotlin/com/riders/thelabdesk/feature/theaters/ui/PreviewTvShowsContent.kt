 ...
 * @param list represents the list we want to display (with [data.local.model.tmdb.TvShowsModel] items)
 */
@Composable
private fun TMDBLazyRowSection(viewModel: TheatersViewModel, title: String, list: List<TvShowsEntity>) {
