 ...
 * @param list represents the list we want to display (with [data.local.model.tmdb.MovieModel] items)
 */
@Composable
private fun TMDBLazyRowSection(viewModel: TheatersViewModel, title: String, list: List<MovieEntity>) {
...
@Composable
private fun Header(viewModel: TheatersViewModel, movie: MovieEntity) {
    val backdropUrl =
